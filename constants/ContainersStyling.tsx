...
export const LARGE_CONTAINER_STYLING = {
	...
	LARGE_ROUNDED_CONTENT_CONTAINER_STYLING: [tw`my-4 w-[90%] h-[206px] rounded-[30px] justify-center items-center`, { borderWidth: 1, borderColor: COLORS.ACCENT_COLOR }],
};

export const OVERLAY_STYLING = [tw`bg-black bg-opacity-50 w-full h-full rounded-[30px] justify-end items-start`];
